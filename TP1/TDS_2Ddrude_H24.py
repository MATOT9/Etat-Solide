...
def main(dt: float, timeLoopLen: int, analyseSphere: int, E: float = 0, render: bool = True) -> [list[Particule]]:
    ...
    electrons: list[Particule] = setupParticules(L, mass, rElec, nElec, T, analyseSphere, render=render)
